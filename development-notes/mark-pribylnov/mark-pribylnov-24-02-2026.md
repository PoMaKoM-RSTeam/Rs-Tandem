...
Единственное что помогло так это дабавить файл в `.prettierignore`. Надеюсь в этом ничего страшного нет.  
Если есть, буду рад узнать сохранить отступы по-другому. Без отступов несколько циклов `@for` сливаются в одну строки с сложно понять что происходит.

Почти 2 часа на PR ушло. В том числе подумать что в описании сделать и 10 раз проверить код нет ли чего лишнего или кривого за что не будет стыдно.
