...
## Что делал
- Освежил те немногие знания что были по реляционным БД. Вроде смысл понятен. Есть таблицы в которых есть данные. В ячецках могут быть как чистые данные так и ссылка на ID элемента из другой таблицы. Поэтому они называются relational ("связанные").
...
### Что дальше:
Сделать анимацию когда по кнопке run loop блоки с кодом анимацией перемещаются в тот порадок в котором они будут исполнены движком JavaScript.
